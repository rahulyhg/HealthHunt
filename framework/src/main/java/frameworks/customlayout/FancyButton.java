...
public class FancyButton  extends LinearLayout{
    ...
    private void initializeFancyButton(){
        ...
        LinearLayout.LayoutParams la = (LayoutParams) mTextView.getLayoutParams();
        la.weight = 0.5f;
        mTextView.setLayoutParams(la);
        mIconView 		= setupIconView();
        LinearLayout.LayoutParams la1 = (LayoutParams) mIconView.getLayoutParams();
        la.weight = 1.5f;
        mIconView.setLayoutParams(la1);
    ...
    private TextView setupFontIconView(){
        ...
        if(mFontIcon!=null){
            ...
            LayoutParams iconTextViewParams = new LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.MATCH_PARENT);
    ...
    private ImageView setupIconView(){
        if (mIconResource != null){
            ...
            LayoutParams iconViewParams = new LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.MATCH_PARENT);
            if(mTextView!=null){
                if(mIconPosition==POSITION_TOP || mIconPosition==POSITION_BOTTOM)
